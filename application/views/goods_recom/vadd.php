                    ...
                    <div class="row">
					    <div class="col-lg-12">
					        <div class="panel">
					            ...
					            <form class="form-horizontal" action="<?php echo base_url('Cgoods_recom/addPost');?>" method="post" enctype="multipart/form-data">
					                <div class="panel-body">
    					                <div class="form-group">
    					                    <label class="col-md-3 control-label" for="demo-text-input">名称*</label>
    					                    <div class="col-md-6">
    					                        <input type="text" class="form-control" name="en_name" required="required" maxlength="20" value="" placeholder="...">
    					                ...
    					                <div class="form-group">
    					                    ...
    					                    <div class="col-md-6">
    					                        <input type="text" class="form-control" name="zh_name" required="required" maxlength="20" value="" placeholder="...">
    					                ...
    					                <div class="form-group">
    					                    ...
    					                    <div class="col-md-6">
        					                    <input class="form-control" style="display: none;" type="text" name="des" placeholder="产品id" value="" data-role="tagsinput">
