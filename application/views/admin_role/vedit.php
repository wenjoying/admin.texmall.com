                    ...
                    <div class="row">
					    <div class="col-lg-12">
					        <div class="panel">
					            ...
					            <form class="form-horizontal" action="<?php echo base_url('Cadmin_role/editPost');?>" method="post" >
					                <div class="panel-body">
    					                <input type="hidden" name="id" value="<?php echo $res->id;?>">
    					                <div class="form-group">
    					                    <label class="col-md-3 control-label" for="demo-email-input">角色名称*</label>
    					                    <div class="col-md-6">
    					                        <input type="text" class="form-control" name="role_name" required="required" maxlength="50" value="<?php echo $res->role_name?>" placeholder="...">
    					                ...
    					                <div class="form-group">
    					                    ...
    					                    <div class="col-md-6">
    					                        <input type="text" class="form-control" name="menu_list" required="required" maxlength="1" value="<?php echo $res->menu_list?>" placeholder="1">
    					                        <small class="help-block">不能重复，格式：Cuser::index</small>
    					                    </div>
    					                </div>
    					                ...
    					                <div class="form-group">
    					                    ...
    					                    <div class="col-md-6">
    					                        <textarea rows="5" class="form-control" placeholder="..." name="des" maxlength="100"><?php echo $res->des?></textarea>
