                    ...
                    <div class="panel">
					    ...
					    <div class="panel-body">
					        <form class="form-inline" action="<?php echo base_url('Cadmin_log/grid');?>" method="get">
					            ...
					            <div class="form-group">
					                <input type="text" class="form-control" name="item" style="width:350px;" value="<?php echo $this->input->get('item');?>" placeholder="日志用户名/电话/IP/方法">
					            </div>
    					                ...
    					                <table class="demo-add-niftycheck table table-hover">
        					                ...
        					                <tbody>
        					                    ...
        					                    <tr>
            					                    ...
            					                    <td>
            					                        <a class="btn-link" href="###" onclick="layer_ask('<?php echo base_url('Cadmin_log/delete/'.$r->id);?>');">删除</a>
                                                    </td>
        					                    </tr>
        					                    <?php endforeach;?>
        					                </tbody>
