                ...
                <div id="page-content">
                    <div class="panel">
					    ...
					    <div class="panel-body">
					        <form class="form-inline" action="<?php echo base_url('Cauthenticate_enterprise/grid');?>" method="get">
					            ...
					            <div class="form-group">
					                <input type="text" class="form-control" name="item" style="width:350px;" value="<?php echo $this->input->get('item');?>" placeholder="企业名称/法人名/法人身份证/通知手机号/开户行/卡号">
					            </div>
    					                ...
    					                <table class="demo-add-niftycheck table table-hover">
    					                    <thead>
        					                    <tr>
                                                    ...
                                                    <th><div class="th-inner">企业法人</div></th>
        					                ...
        					                <tbody>
        					                    ...
        					                    <tr>
            					                    <td><?php echo $r->id?></td>
                                                    <td><a class="btn-link" href="<?php echo base_url('Csupplier_buyer/page/'.$r->companyid)?>"><?php echo $r->enterprise_name?></a></td>
                                                    <td><?php echo $r->enterprise_legal?></td>
                                                    <td><?php echo $r->link_phone?></td>
            					                    ...
            					                    <td>
            					                        <a class="btn-link" href="<?php echo base_url('Cauthenticate_enterprise/page/'.$r->id);?>">查看</a>|
            					                        <a class="btn-link" href="###" onclick="layer_ask('<?php echo base_url('Cauthenticate_enterprise/delete/'.$r->id);?>');">删除</a>
                                                    </td>
        					                    </tr>
        					                    <?php endforeach;?>
        					                </tbody>
