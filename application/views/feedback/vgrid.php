                    ...
                    <div class="panel">
					    ...
					    <div class="panel-body">
					        ...
					        <form class="form-inline" action="<?php echo base_url('Cfeedback/grid');?>" method="get">
					            ...
					            <div class="form-group">
					                <input type="text" class="form-control" name="item" value="<?php echo $this->input->get('item');?>" placeholder="用户名/电话">
					            </div>
    					                ...
    					                <table class="demo-add-niftycheck table table-hover">
        					                ...
        					                <tbody>
        					                    ...
        					                    <tr>
            					                    ...
            					                    <td><?php echo $r->username.'</br>'.$r->mobile?></td>
            					                    ...
            					                    <td>
                					                    ...
                					                    <?php endif;?>
                					                    <a class="btn-link" href="###" onclick="layer_conf('<?php echo base_url('Cfeedback/delete/'.$r->id);?>');">删除</a>
                                                    </td>
        					                    </tr>
        					                    <?php endforeach;?>
        					                </tbody>
