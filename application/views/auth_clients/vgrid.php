                    ...
                    <div class="panel">
					    <div class="panel-heading">
					        <h3 class="panel-title">
    					        <?php echo $two_level?>
					            <a style="margin-left:50px;" href="<?php echo base_url('Cauth2/add');?>"><button class="btn btn-success"><i class="ion-plus-round"></i>添加</button></a>
    					                ...
    					                <table class="demo-add-niftycheck table table-hover">
    					                    <thead>
        					                    <tr>
                                                    ...
                                                    <th><div class="th-inner">应用appid</div></th>
                                                    <th><div class="th-inner">应用secret</div></th>
                                                    <th><div class="th-inner">回调地址redirect_url</div></th>
        					                ...
        					                <tbody>
        					                    ...
        					                    <tr>
            					                    ...
            					                    <td>
            					                        <a class="btn-link" href="###" onclick="layer_conf('<?php echo base_url('Cauth2/delete/'.$r->id);?>');">删除</a>
                                                    </td>
        					                    </tr>
        					                    <?php endforeach;?>
        					                </tbody>
