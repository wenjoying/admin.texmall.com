    					                ...
    					                <table class="demo-add-niftycheck table table-hover">
    					                    <thead>
        					                    <tr>
                                                    ...
                                                    <th width="10%"><div class="th-inner">应用名称</div></th>
                                                    <th width="10%"><div class="th-inner">应用appid</div></th>
                                                    <th width="10%"><div class="th-inner">应用secret</div></th>
                                                    <th width="20%"><div class="th-inner">回调地址redirect_url</div></th>
            					                    ...
            					                    <td>
                                                        <div class="btn-group m-b-5">
                                                            ...
                                                            <ul class="dropdown-menu animated fadeIn">
                                                                <li><a href="javascript:layer_conf('<?php echo base_url('Cauth2/delete/'.$r->id);?>');"><i class="ion-trash-a"></i>删除</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
        					                    </tr>
