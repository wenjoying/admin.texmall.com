					        ...
					        <form class="form-inline" action="<?php echo base_url('Csearch_log/grid');?>" method="get">
					            <div class="form-group">
    					            <select class="selectpicker" name="type">
                                        ...
                                        <option <?php if($this->input->get('type')=='2')echo 'selected="selected"'?> value="2">图片</option>
                                    </select>
					            </div>
					            ...
					            <div class="form-group">
					                <input type="text" class="form-control" name="item" value="<?php echo $this->input->get('item');?>" placeholder="用户名/搜索内容">
					            </div>
    					                ...
    					                <table class="demo-add-niftycheck table table-hover">
        					                ...
        					                <tbody>
        					                    ...
        					                    <tr>
            					                    ...
            					                    <td>
            					                        <a class="btn-link" href="###" onclick="layer_conf('<?php echo base_url('Csearch_log/delete/'.$r->id);?>');">删除</a>
                                                    </td>
        					                    </tr>
        					                    <?php endforeach;?>
        					                </tbody>
