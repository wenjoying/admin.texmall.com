                    ...
                    <div class="row">
					    <div class="col-lg-12">
					        <div class="panel">
					            ...
					            <form class="form-horizontal" action="<?php echo base_url('Cad_img/addPost');?>" method="post" enctype="multipart/form-data">
					                <div class="panel-body">
    					                <div class="form-group">
    					                    <label class="col-md-3 control-label">图片*</label>
    					                    <div class="col-md-6">
    					                        <input type="file" class="form-control" style="height: 100px;opacity: 0;width: 100px;" name="ad_img" required="required">
    					                ...
    					                <div class="form-group">
    					                    ...
    					                    <div class="col-md-6">
    					                        <input type="text" class="form-control" name="ad_name" required="required" maxlength="20" value="" placeholder="...">
    					                ...
    					                <div class="form-group">
    					                    ...
    					                    <div class="col-md-6">
    					                        <input type="url" class="form-control" name="ad_url" maxlength="100" value="" placeholder="...">
    					                ...
    					                <div class="form-group">
    					                    ...
    					                    <div class="col-md-6">
    					                        <textarea rows="5" class="form-control" placeholder="..." name="ad_info" maxlength="100"></textarea>
    					                    </div>
    					                </div>
    					                ...
    					                <div class="form-group">
    					                    ...
    					                    <div class="col-md-6">
    					                        <input type="text" class="form-control" name="reorder" required="required" maxlength="1" value="9" placeholder="...">
