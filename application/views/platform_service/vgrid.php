<?php $this->load->view('layout/header');?>
                ...
                <div id="page-content">
                    <div class="panel">
					    <div class="panel-heading">
					        <h3 class="panel-title" id="demo-bootbox-custom-h-content">
    					        <?php echo $two_level?>
					            <a style="margin-left:50px;" href="<?php echo base_url('Cplatform_service/add');?>"><button class="btn btn-success"><i class="ion-plus-round"></i>添加</button></a>
					    ...
					    <div class="panel-body">
					        <form class="form-inline" action="<?php echo base_url('Cplatform_service/grid');?>" method="get">
					            ...
					            <div class="form-group">
					                <input type="text" class="form-control" name="item" style="width:350px;" value="<?php echo $this->input->get('item');?>" placeholder="用户名/电话/地址">
					            </div>
    					                ...
    					                <table class="demo-add-niftycheck table table-hover">
        					                ...
        					                <tbody>
        					                    ...
        					                    <tr data-checkid="<?php echo $r->id?>" data-username="<?php echo $r->username?>">
                                                    ...
                                                    <td><?php echo $r->apply_des?></td>
                                                    <td style="color:red;"><?php echo $status_arr[$r->status]?></td>
                                                    <td><?php echo date('Y-m-d H:i:s', $r->time);?></td>
            					                    <td>
            					                        <a class="btn-link" href="<?php echo base_url('Cplatform_service/page/'.$r->id);?>">查看</a>|
            					                        <a class="btn-link" href="###" onclick="layer_ask('<?php echo base_url('Cplatform_service/delete/'.$r->id);?>');">删除</a>
                                                    </td>
        					                    </tr>
        					                    <?php endforeach;?>
        					                </tbody>
					...
					<div class="panel">
		                ...
		                <div class="panel-body">
		                    <p>1.在“<b>正在审核</b>”的状态下，可以点击“<b>查看</b>”进行审核。</p>
		                </div>
		            </div>
                </div>
                <!--===================================================-->
