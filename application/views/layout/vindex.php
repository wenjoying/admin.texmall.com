<?php $this->load->view('layout/header');?>
                ...
                <div class="block-area shortcut-area">
                    <a class="shortcut tile" href="<?php echo base_url('Cadmin_user/index')?>">
                        <img src="<?php inc_file('icon/home@2x.png')?>" alt="">
                        <small class="t-overflow">首页</small>
                    </a>
                    <a class="shortcut tile" href="<?php echo base_url('Cuser/grid')?>">
                        <img src="<?php inc_file('icon/chart@2x.png')?>" alt="">
                        <small class="t-overflow">用户管理</small>
                    </a>
                    <a class="shortcut tile" href="<?php echo base_url()?>">
                        <img src="<?php inc_file('icon/pages@2x.png')?>" alt="">
                        <small class="t-overflow">产品中心</small>
                    </a>
                    <a class="shortcut tile" href="<?php echo base_url('Cadmin_user/profile')?>">
                        <img src="<?php inc_file('icon/folder@2x.png')?>" alt="">
                        <small class="t-overflow">后台管理员</small>
                    </a>
                    <a class="shortcut tile" href="<?php echo base_url()?>">
                        <img src="<?php inc_file('icon/widgets@2x.png')?>" alt="">
                        <small class="t-overflow">网站设置</small>
                    </a>
                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="tile">
                                        ...
                                        <div class="listview narrow">
                                            ...
                                            <div class="media p-l-5">
                                                <div class="pull-left">
                                                    <img width="40" src="<?php inc_file('profile-pics/2.jpg')?>" alt="">
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <div class="media p-l-5">
                                                <div class="pull-left">
                                                    <img width="40" src="<?php inc_file('profile-pics/3.jpg')?>" alt="">
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <div class="media p-l-5">
                                                <div class="pull-left">
                                                    <img width="40" src="<?php inc_file('profile-pics/4.jpg')?>" alt="">
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <div class="media p-l-5">
                                                <div class="pull-left">
                                                    <img width="40" src="<?php inc_file('profile-pics/5.jpg')?>" alt="">
                                                </div>
                                                <div class="media-body">
                ...
                <div class="chat">
                    ...
                    <div class="pull-left chat-list">
                        <div class="listview narrow">
                            <div class="media">
                                <img class="pull-left" src="<?php inc_file('profile-pics/1.jpg');?>" width="30" alt="">
                                <div class="media-body p-t-5">
                                    Alex Bendit
                                </div>
                            </div>
                            <div class="media">
                                <img class="pull-left" src="<?php inc_file('profile-pics/2.jpg')?>" width="30" alt="">
                                <div class="media-body">
                                    <span class="t-overflow p-t-5">David Volla Watkinson</span>
                                </div>
                            </div>
                            <div class="media">
                                <img class="pull-left" src="<?php inc_file('profile-pics/3.jpg')?>" width="30" alt="">
                                <div class="media-body">
                                    <span class="t-overflow p-t-5">Mitchell Christein</span>
                                </div>
                            </div>
                            <div class="media">
                                <img class="pull-left" src="<?php inc_file('profile-pics/4.jpg')?>" width="30" alt="">
                                <div class="media-body">
                                    <span class="t-overflow p-t-5">Wayne Parnell</span>
                                </div>
                            </div>
                            <div class="media">
                                <img class="pull-left" src="<?php inc_file('profile-pics/5.jpg')?>" width="30" alt="">
                                <div class="media-body">
                                    <span class="t-overflow p-t-5">Melina April</span>
                                </div>
                            </div>
                            <div class="media">
                                <img class="pull-left" src="<?php inc_file('profile-pics/6.jpg')?>" width="30" alt="">
                                <div class="media-body">
                    ...
                    <div class="media-body">
                        ...
                        <div class="chat-body">
                            <div class="media">
                                <img class="pull-right" src="<?php inc_file('profile-pics/1.jpg')?>" width="30" alt="" />
                            ...
                            <div class="media pull-right">
                                <img class="pull-right" src="<?php inc_file('profile-pics/2.jpg')?>" width="30" alt="" />
                                <div class="media-body">
