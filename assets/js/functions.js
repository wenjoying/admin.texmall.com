$(document).ready(function(){
	...
	if($('.date-only')[0]) {
	    $('.date-only').datetimepicker({
	    	daysShort: ["日", "Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"],
	    	pickTime: false
	    });
	}
